...
readability <- textstat_readability(corpus_articles, measure ="Flesch.Kincaid")
...
articlesRich$titleCertaintyScore <- getScore(certainty, title_dfm)
...
articlesRich$titleCertaintyScore[is.na(articlesRich$titleCertaintyScore)] <-0
...
articlesRich$articleCertaintyScore <- getScore(certainty, article_dfm)
...
comments$commentsCertaintyScore <- getScore(certainty, comments_dfm)
...
comments$commentsCertaintyScore[is.na(comments$commentsCertaintyScore)] <-0
...
comments_scores <- comments %>%
  ...
  summarise(commentsAngerScore= mean(commentsAngerScore),
            ...
            commentsCertaintyScore= mean(commentsCertaintyScore),)
...
articlesRich2 <- articlesRich[10001:17787,]
